...
if __name__ == "__main__":
    ...
    fold = 'G:/trading/'
    fold = 'E:/Strategy/TCS/backtest/'
    df = []
    method = '30_15'
    s_date = '2017-01-01'
    e_date = '2020-01-01'
    for symbol in symbols_all:
        result_folder = 'e://Strategy//TCS//backtest//2010_9mutipara_%s' % ('_'.join([i for i in [symbol]]))
        data = pd.read_csv(result_folder + '//sharpe_dataframe.csv', index_col=0) \
    ...
    print(df)
    df.to_csv(fold + 'sharpe_state' + '_20179.csv', encoding='gbk')